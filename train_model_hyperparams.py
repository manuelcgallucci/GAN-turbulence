...
if __name__ == '__main__':
    ...
    with mp.Pool(processes=2) as pool:
        ...
        for weights_losses in weights_losses_arr:
            ...
            res = pool.apply_async(train_model, (epochs, batch_size, k_epochs_d, weights_sample_losses, weights_losses, data_type, data_stride, len_samples, out_dir, noise_size,))
